    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("NoirShares") + " - " + tr("Wallet"));
        this->setStyleSheet("QMainWindow {background-color: rgb(132, 132, 132); color: rgb(255, 255, 255);}" );
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NoirShares address"));
    ...
    votingAction = new QAction(QIcon(":/icons/metacontact_unknown"), tr("&Vote"), this);
    ...
    aboutAction->setStatusTip(tr("Show information about NoirShares"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for NoirSShares"));
    ...
    miningOffAction->setToolTip(tr("Stop Mining. May take some time to wind down."));
    miningOneAction = new QAction(QIcon(":/icons/mining_active"), tr("Solo Mining On (1GB Required)"), this);
    miningOneAction->setToolTip(tr("Mine with 1 process - not recommended!"));
    miningTwoAction = new QAction(QIcon(":/icons/mining"), tr("Mine 2 Processes ( ~1.5GB Required)"), this);
    miningTwoAction->setToolTip(tr("Mine with 2 processes. ~2GB Required."));
    miningThreeAction = new QAction(QIcon(":/icons/mining"), tr("Mine 4 Processes (3.5GB Required)"), this);
    miningThreeAction->setToolTip(tr("Mine with 4 processes. ~3.5GB Required."));
    miningFourAction = new QAction(QIcon(":/icons/mining"), tr("Mine all cores/threads Processes (~750MB Required per thread)"), this);
    miningFourAction->setToolTip(tr("Mine with all cores/threads. ~750MB Required per thread."));
    currentVotesAction = new QAction(QIcon(":/icons/voting_prefs"), tr("Current Voting Preferences"), this);
    currentVotesAction->setToolTip(tr("Show who or what you are currently voting for. (Web)"));
    currentCandidatesAction = new QAction(QIcon(":/icons/voting_candidates"), tr("Current Candidates"), this);
    currentCandidatesAction->setToolTip(tr("Display a list of current candidates. (Web)"));
    howToVoteAction = new QAction(QIcon(":/icons/voting_how"), tr("How To Vote"), this);
    howToVoteAction->setToolTip(tr("Information about how to cast your vote. (Web)"));
    currentResultsAction = new QAction(QIcon(":/icons/voting_results"), tr("Latest Election Results"), this);
    currentResultsAction->setToolTip(tr("Current board and past results. (Web)"));
    signMessageAction = new QAction(QIcon(":/icons/edit"), tr("Sign &message..."), this);
    signMessageAction->setStatusTip(tr("Sign messages with your NoirShares addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NoirShares addresses"));
...
{
    QString strTitle = tr("NoirShares"); // default title
...
void BitcoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(BitcoinUnits::formatWithUnit(BitcoinUnits::NRS, nFeeRequired));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid NoirShares address or malformed URI parameters."),
