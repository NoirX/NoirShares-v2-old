...
QT_TRANSLATE_NOOP("bitcoin-core", "NoirShares version"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Error loading wallet.dat: Wallet requires newer version of NoirShares"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "SSL options: (see the NoirShares Wiki for SSL setup instructions)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Select the version of socks proxy to use (4-5, default: 5)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Send command to -server or NoirSharesd"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Specify configuration file (default: NoirShares.conf)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Specify connection timeout in milliseconds (default: 5000)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Specify data directory"),
QT_TRANSLATE_NOOP("bitcoin-core", "Specify pid file (default: NoirSharesd.pid)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Wallet needed to be rewritten: restart NoirShares to complete"),
