...
/** Interface to NoirShares Secure Messaging Invoices from Qt view code. */
...
/** Interface to NoirShares Secure Messaging Invoice Items from Qt view code. */
...
/** Interface to NoirShares Secure Messaging Receipts from Qt view code. */
