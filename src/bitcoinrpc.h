...
extern json_spirit::Value gethashespermin(CWallet* pWallet, const json_spirit::Array& params, bool fHelp);
...
extern json_spirit::Value getnetworkhashps(CWallet* pWallet, const json_spirit::Array& params, bool fHelp);
